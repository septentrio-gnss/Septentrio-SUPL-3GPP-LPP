...
args::Group septentrio_receiver_group{
    "Septentrio Receiver:",
    args::Group::Validators::AllOrNone,
    args::Options::Global,
};

args::ValueFlag<std::string> septentrio_serial_device{
    septentrio_receiver_group, "device", "Device", {"septentrio-serial"}, args::Options::Single};
...
static SeptentrioOptions septentrio_parse_options() {
    if (septentrio_serial_device) {
        auto devices      = septentrio_serial_device.Get();
        return SeptentrioOptions{devices};
    } else {
        return SeptentrioOptions{};
    }
}
...
int OptionParser::parse_and_execute(int argc, char** argv) {
        ...
        args_commands.emplace_back(
            new args::Command(commands, command->name(), command->description(),
                              [command_ptr](args::Subparser& parser) {
                                  ...
                                  options.septentrio_options      = septentrio_parse_options();
    ...
    args::GlobalOptions septentrio_receiver_globals{parser, septentrio_receiver_group};
